...
interface GetTrackLyricsTranslationResponse {
    message: {
        header: Header;
        body: {
...
export type { GetAlbumResponse, GetAlbumTracksResponse, GetArtistAlbumsResponse, GetArtistResponse, GetLyricsResponse, GetTrackLyricsTranslationResponse, GetTrackResponse, SearchArtistsResponse, SearchTracksResponse };
